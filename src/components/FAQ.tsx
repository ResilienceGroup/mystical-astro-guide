      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Accordion type="single" collapsible className="w-full space-y-4">
          <AccordionItem value="item-1" className="border border-white/10 rounded-lg px-4">
            <AccordionTrigger className="text-left">Comment fonctionne Moon Astral pour mon entreprise ?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-2" className="border border-white/10 rounded-lg px-4">
            <AccordionTrigger className="text-left">Les prédictions sont-elles vraiment fiables pour les décisions business ?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-3" className="border border-white/10 rounded-lg px-4">
            <AccordionTrigger className="text-left">Comment sont protégées mes données stratégiques ?</AccordionTrigger>
            <AccordionContent>
